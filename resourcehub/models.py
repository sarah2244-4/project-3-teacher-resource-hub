...
class Subject(db.Model):
    ...
    resources = db.relationship("Resource", backref="subject", cascade="all, delete", lazy=True)
...
class EducationLevel(db.Model):
    ...
    resources = db.relationship("Resource", backref="education_level", cascade="all, delete", lazy=True)
